...
const ProjectPayment = () => {
  ...
  const price = safeProject.price || 0;
  const originalPrice = safeProject.originalPrice || 0;
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-gray-200 dark:border-gray-600 pt-4 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600 dark:text-gray-400 line-through">₹{originalPrice.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
