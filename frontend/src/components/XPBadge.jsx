  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center gap-2 px-3 py-1.5 ${levelInfo.bgColor} backdrop-blur-sm rounded-full transition-all duration-300 hover:scale-105 cursor-pointer border ${levelInfo.borderColor}`}
      ...
      <AnimatePresence>
        {isDropdownOpen && (
          <motion.div
            ...
            className="absolute top-full right-0 mt-2 w-80 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/30 dark:border-gray-700/30 z-50 overflow-hidden"
          >
            {loading ? (
              <div className="p-6 text-center">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto mb-4"></div>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Loading XP data...</p>
              </div>
            ) : (
              <div className="p-6">
                {/* Header */}
